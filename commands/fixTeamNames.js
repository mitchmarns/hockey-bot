// Fix Team Names command handler
const { EmbedBuilder } = require('discord.js');

async function fixTeamNames(interaction) {
  try {
    ...
    const botTeams = await db.all('SELECT id, name, city FROM teams WHERE name LIKE "%[BOT]%"');
